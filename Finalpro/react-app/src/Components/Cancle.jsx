...
const [date, setDate] = useState('');
  ...
  const handleSubmit = () => {
    ...
    axios.delete(`http://localhost:8080/products/map/event/del/booking/${email}`,  eventData )
      .then(response => { 
        navigate("/Home");
        window.alert("Form cancel successfully!"); //cancel
  ...
  return (
    <>
      <div className='b-c-b-1'>
       
        <center>
          <div className="cancle-1">
            <h1 className='h1-book-event'>Cancel The Event</h1>
            <TextField
              label="Email"
              sx={{ width: '300px' }}
              required
